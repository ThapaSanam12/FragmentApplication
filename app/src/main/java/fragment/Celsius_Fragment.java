 ...
 */
public class Celsius_Fragment extends Fragment implements View.OnClickListener {

    private Button btncelsius;
    private EditText etfah,etresult;

    public Celsius_Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_celsius_,container,false);
